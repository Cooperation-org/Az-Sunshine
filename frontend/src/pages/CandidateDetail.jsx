...
export default function CandidateDetail() {
        ...
        <main className="flex-1 lg:ml-0">
          ...
          <div className="p-8">
            <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-8 text-center">
              ...
              <p className="text-red-700 mb-6">{error || "Candidate not found"}</p>
              <button
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-gray-50">
      <Sidebar />
      ...
      <main className="flex-1 lg:ml-0">
        ...
        <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          <button
            onClick={() => navigate("/candidates")}
            className="mb-6 px-4 py-2 bg-white text-gray-700 rounded-xl font-medium hover:bg-gray-50 transition-all inline-flex items-center gap-2 shadow-sm border border-gray-200 hover:shadow-md"
          >
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-8 mb-6 text-white shadow-2xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
                    <p className="text-purple-100 text-xs mb-1">Party</p>
                    <p className="font-bold text-lg">{candidate.party?.name || "Unknown"}</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
                    <p className="text-purple-100 text-xs mb-1">Cycle</p>
                    <p className="font-bold text-lg">{candidate.cycle?.name || "N/A"}</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3">
                    <p className="text-purple-100 text-xs mb-1">Committee ID</p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
                <p className="text-purple-100 text-sm mb-2">Total IE Spending</p>
          ...
          {activeTab === "expenditures" && (
            <div className="space-y-6">
              {/* Filter Bar */}
              <div className="bg-white rounded-2xl p-4 shadow-lg border border-gray-200 flex flex-wrap items-center justify-between gap-4">
                      ...
                      {expendituresLoading ? (
                        <tr>
                          <td colSpan="5" className="px-6 py-8 text-center">
                            ...
                            <p className="text-gray-600">Loading expenditures...</p>
                          </td>
                        </tr>
...
function StatCard({ icon: Icon, label, value, bgColor, percentage }) {
  return (
    <div className={`${bgColor} rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1`}>
