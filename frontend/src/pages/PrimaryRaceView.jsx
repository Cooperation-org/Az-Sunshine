                        ...
                        >
                          <div className="flex-1">
                            ...
                            <div className="text-sm mt-1">
                              <span className={spender.benefit === 'Support' || spender.benefit === 'For Benefit' ? 'text-green-500' : 'text-red-500'}>
                                {spender.benefit === 'Support' ? 'For Benefit' : spender.benefit === 'Oppose' ? 'Not For Benefit' : spender.benefit}
                              </span>
                              <span className={darkMode ? 'text-gray-400' : 'text-gray-600'}>
                                {' '}{spender.candidate}
                              </span>
